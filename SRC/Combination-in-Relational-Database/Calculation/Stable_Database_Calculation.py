...
cols = list(pd.read_csv('/dbfs/mnt/testmount/data/stable_database_columns.csv')['Keeping columns'].dropna())
cols
...
combine.to_csv(os.path.join('/dbfs/mnt/testmount/stable_database/stable_combined.csv'), index=False)
