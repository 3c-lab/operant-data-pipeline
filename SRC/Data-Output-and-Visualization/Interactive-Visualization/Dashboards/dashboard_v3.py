...
#data_files = os.listdir(os.path.join('/Users/yunyihuang/Desktop/georgelab/gl_local/data'))
...
def update_data(input_file):
    if input_file:
        filepath = '/Users/yunyihuang/Desktop/georgelab/gl_local/data/' + str(input_file)
        df = cleanup(filepath)
