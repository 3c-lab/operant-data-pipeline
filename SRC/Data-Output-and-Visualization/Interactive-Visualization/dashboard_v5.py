...
def parse_contents(contents, filename, date):
    ...
    try:
        ...
        # Add burst calculations to the df_actions
        df_burst = calculations_single(df)
        df_actions = df_actions.merge(df_burst, how='inner', on='Subject')
...
if __name__ == "__main__":
    app.run_server(port=os.getenv('PORT', '1192'),
                   debug = True)