...
TRIAL_LGA_PATH_E = '/Users/yunyihuang/Desktop/gl_data/OXYCODONE/NEW_LGA'
TRIAL_LGA_FILES = (
    ...
    # + 
    [os.path.join(TRIAL_LGA_PATH_E, i) for i in sorted(os.listdir(TRIAL_LGA_PATH_E)) if (i != '.DS_Store')]
)
